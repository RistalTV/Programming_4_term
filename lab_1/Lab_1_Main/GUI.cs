...
namespace Lab_1_Main
{
    static public class GUI
    {
        ...
        private static void Exam()
        {
            ...
            e.Math = Input_Item(e.Math, "Экзамен");
            // В данный момент идёт заполнение предмета: 'Иностранный язык'      
            e.Foreign_language = Input_Item(e.Foreign_language, "Экзамен");
            // В данный момент идёт заполнение предмета: 'Русский язык'      
            e.Russian_language = Input_Item(e.Russian_language, "Экзамен");
        ...
        private static void Trial()
        {
            ...
            e.Data_Analysis= Input_Item(e.Data_Analysis, "Испытание");
            // В данный момент идёт заполнение предмета: 'Структуры данных'      
            e.Data_structures = Input_Item(e.Data_structures, "Испытание");
            // В данный момент идёт заполнение предмета: 'Машинное обучение'      
            e.Deep_learning = Input_Item(e.Deep_learning, "Испытание");
            // В данный момент идёт заполнение предмета: 'Математика'      
            e.Math = Input_Item(e.Math, "Испытание");
            // В данный момент идёт заполнение предмета: 'Иностранный язык'      
            e.Foreign_language = Input_Item(e.Foreign_language, "Испытание");
            // В данный момент идёт заполнение предмета: 'Русский язык'      
            e.Russian_language = Input_Item(e.Russian_language, "Испытание");
        ...
        private static void Final_Exam()
        {
            ...
            e.Physics= Input_Item(e.Physics, "Выпускной Экзамен");
            // В данный момент идёт заполнение предмета: 'Информатика'      
            e.Programming= Input_Item(e.Programming, "Выпускной Экзамен");
            // В данный момент идёт заполнение предмета: 'Программирование'      
            e.Informatics= Input_Item(e.Informatics, "Выпускной Экзамен");
            // В данный момент идёт заполнение предмета: 'Математика'      
            e.Math = Input_Item(e.Math, "Выпускной Экзамен");
            // В данный момент идёт заполнение предмета: 'Иностранный язык'      
            e.Foreign_language = Input_Item(e.Foreign_language, "Выпускной Экзамен");
            // В данный момент идёт заполнение предмета: 'Русский язык'      
            e.Russian_language = Input_Item(e.Russian_language, "Выпускной Экзамен");
        ...
        public static Class_Academic_Subject Input_Item(Class_Academic_Subject e, string nameClass)
        {
            GUI.Header(new List<string>
                {
                    $"Класс '{nameClass}'",
